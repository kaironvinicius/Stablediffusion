...
| --- | --- | --- | --- | --- |
| `sd-turbo` | 2 | 0.0 | 1024 | Default. The only preset with tolerable CPU latency. |
...
was trained at. 768px is the best balance; 1024px trades a visibly busier
composition for detail.
